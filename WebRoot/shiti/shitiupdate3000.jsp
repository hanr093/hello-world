...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" >
       				 <input type="text" name="daan"  id='daanid' value="${bean.nandu }"  readonly="readonly" size="50"/>
      </td>
    ...
    <tr>
      ...
      <td class="td_bg" >
      <textarea rows="7" cols="50" name="wenti" readonly="readonly" >${bean.wenti }</textarea>
     ...
     <tr>
      ...
      <td class="td_bg" >
       ...
       <textarea rows="7" cols="50" name="daan" readonly="readonly" >${bean.daan }</textarea>
