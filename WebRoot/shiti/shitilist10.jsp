...
<div align="left">
<br/>
<a href="${url2 }add10?kechengid=${kechengid }"><span style="font-size: 20px;">添加新判断题</span></a>&nbsp;&nbsp;
...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <tr>
      ...
      <a href="${url2 }update30?id=${bean.id }"><span style="font-size: 15px;">查看</span></a>
      <a href="${url2 }update10?id=${bean.id }"><span style="font-size: 15px;">修改</span></a>
      <a href="${url2 }delete10?id=${bean.id }" onclick="return confirm('确定要删除吗?');"><span style="font-size: 15px;">删除</span></a>
