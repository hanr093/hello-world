...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" >
      <input type="text" name="xingming" id="xingmingid"   size="50"  value="${bean.xingming }"/>
      </td>
    ...
    <tr>
      ...
      <td class="td_bg" >
      <input type="text" name="tel" id="telid"   size="50" value="${bean.tel }" />
      </td>
    ...
    <tr>
      ...
      <td class="td_bg" >
      	...
      	<option value="${kecheng.id }" <c:if test="${bean.kecheng.id==kecheng.id }">selected</c:if> >${kecheng.mingchen }</option>
      	</c:forEach>
      	</select>
